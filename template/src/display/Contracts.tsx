...
import { ContractConfig } from '../../web3.config.ts'
  ...
  return (
    <div className="panel-full">
      ...
      {noContracts ? (
        ...
        Object.values(activeChainContracts).map((contract: ContractConfig, index) => (
          <div className="contract-row" key={index}>
            <div className="contract-row-title">
              ...
              <h3>
                <a
                  href={activeChain.blockExplorers?.default.url + '/address/' + contract.address}
                  target="_blank"
